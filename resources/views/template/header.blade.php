        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarResponsive">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ Route::currentRouteName() === 'list-product' || Route::currentRouteName() === 'detail-product' ? ' nav-active' : '' }}" href="#" data-bs-toggle="dropdown" aria-expanded="false">PRODUCTS</a>
